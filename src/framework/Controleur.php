...
abstract class Controleur
{
     ...
     */
    protected function genererVue($donneesVue = array(), $action = null, $layout = null)
    {
        ...
        $classeControleur = get_class($this);
        $controleurVue = str_replace("Controler", "", $classeControleur);

        // Instanciation et génération de la vue
        $vue = new Vue($actionVue, $controleurVue);
        $vue->generer($donneesVue, $layout);
    }
